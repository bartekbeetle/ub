...
export async function POST(req: Request) {
  ...
  const user = rows[0];
  // Zawsze wykonujemy jedno porównanie bcrypt — atrapa gdy konta nie ma — żeby czas odpowiedzi
  // nie zdradzał, czy e-mail istnieje (ochrona przed enumeracją, audyt 21.09).
